...
#
# Delete cif.observable format indices from elasticsearch maintaining only a
# specified number.
#   http://logstash.net
...
OPTIONS:
  -h    Show this message
  -i    Indices to keep (default: 1095)
  -e    Elasticsearch URL (default: http://localhost:9200)
  -g    Consistent index name (default: cif.observables)
...
EXAMPLES:
  ...
  ./elasticsearch-remove-old-indices.sh
    ...
    'cif.observables'. Keep the top lexicographical 1095 indices, delete any others.
